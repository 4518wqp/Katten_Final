...
def retrieve(filenumber="1200", toc=35213, topK=5, query="", methods="vector", csv_path="../function_calls/hyperlink_df.csv"):
...
def retrieve_subsection_vector(topK=5, vector_db=None, query="", csv_path="../function_calls/hyperlink_df.csv"):
...
def retrieve_subsection_bm25(topK=5, vector_db=None, query="", csv_path="../function_calls/hyperlink_df.csv"):
...
def retrieve_subsection_rff(topK=5, vector_db=None, query="", csv_path="../function_calls/hyperlink_df.csv"):
